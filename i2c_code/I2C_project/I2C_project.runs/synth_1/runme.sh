...
HD_PWD='C:/Users/USER/Documents/TrainingWaveLet/RTL_Projects/I2C_project/I2C_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log i2c_controller_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source i2c_controller_tb.tcl
